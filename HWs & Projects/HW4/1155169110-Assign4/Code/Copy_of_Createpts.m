...
% epipoleHC1 = null(F.');
% plot(epipoleHC1(1)/epipoleHC1(3),epipoleHC1(2)/epipoleHC1(3),'go'); % draw epipole
% l1 =  F * p2;
% title('Inliers and Epipolar Lines in First Image'); hold on;
% plot(p1_m(inliers,1),p2 (inliers,2),'go')

%% test drawing epipolar line
matchedPoints1 = p1_m;
matchedPoints2 = p2_m;
...
points = lineToBorderPoints(epiLines,size(I1));% Compute the intersection points of the lines and the image border.
